...
# ╔═╡ 589adc80-9201-11ed-3146-a55f8303cf61
using DiffEqOperators, DomainSets, OrdinaryDiffEq, DifferentialEquations, ModelingToolkit, CairoMakie, LinearAlgebra, PlutoUI, Random, StatsBase, Distributions, DataFrames, SpecialFunctions, MethodOfLines, GLMakie, PlutoUI
...
#old code below, for references

# ╔═╡ ca443d3d-b3e0-4ff4-99e0-01c62ed8ea80
begin
	#=

	#=
	utilizing wind profile, not sure how to do this... lets just rely on Fick's law
	=#
	@parameters t U V Kₓ₁ Kₓ₂ λ
	@variables x1(t) x2(t) C(x1, x2, t)
	Dt = Differential(t)
	Dx1 = Differential(x1)
	Dx2 = Differential(x2)
	
	eqs = [Dt(C) + U*Dx1(C) + V*Dx2(C) ~ Kₓ₁*Dx1(Dx1(C)) + Kₓ₂*Dx2(Dx2(C)) - λ*C]
...
# ╔═╡ 1fd08852-4072-4581-9235-9a9b7e1eee75
begin
...
md"
grid points and concentration notes:
*  1 mol of ideal gass has volume of 22.41 L
...
git-tree-sha1 = "863017fd2d2e30e9505bb1b08ba722cbf48bb58a"
